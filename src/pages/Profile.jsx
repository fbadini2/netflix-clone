...
const Profile = () => {
  ...
  return (
    ...
    <div>
      <div>
        ...
        <div className='absolute top-[20%] p-4 md:p-8'>
          <h1 className='text-3xl md:text-4xl font-nsans-bold my-2'>My Shows</h1>
    ...
    <div className='relative flex items-center group'>
        <MdChevronLeft onClick={()=> slide(-500)} className='bg-white rounded-full absolute left-2 opacity-70 text-gray-700 z-10 hidden group-hover:block cursor-pointer' size={35}/>
        <div 
        id={`slider`}
        ...
        <MdChevronRight onClick={()=> slide(500)} className='bg-white rounded-full absolute right-2 opacity-70 text-gray-700 z-10 hidden group-hover:block cursor-pointer' size={35}/>
    </div>
